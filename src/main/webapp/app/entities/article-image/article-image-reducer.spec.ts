...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ARTICLEIMAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ARTICLEIMAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ARTICLEIMAGE actions', async () => {
      const arg = { id: 12245 };
    ...
    it('dispatches UPDATE_ARTICLEIMAGE actions', async () => {
      const arg = { id: 12245 };
    ...
    it('dispatches PARTIAL_UPDATE_ARTICLEIMAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ARTICLEIMAGE actions', async () => {
      const arg = 42666;
